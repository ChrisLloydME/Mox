...
- Implementation: native AppKit `AboutWindowController`, 660 x 354 point fixed-size content area.
...
- About window construction test specifies the 660 x 354 content area and the presence of the application-name and application-icon views.
